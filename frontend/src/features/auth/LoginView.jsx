  ...
  return (
    <div className="animate-slide-up" style={{
      ...
      <div style={{
        ...
        {/* Login Card */}
        <div className="stat-card-modern" style={{ width: '100%', backgroundColor: 'var(--blanco)', borderRadius: '32px', padding: '32px', border: 'none', boxShadow: '0 8px 32px rgba(0,0,0,0.04)', boxSizing: 'border-box' }}>
          {view === 'login' && (
            <>
